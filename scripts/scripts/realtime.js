...
// Membutuhkan: devices[], dataMap[], MAX_SLAVE_ID, formatOperatingTime()
// =======================================================
...
const mqttClient = (() => {
    ...
    const handleMessage = (topic, message) => {
        try {
            ...
            if (devices[id]) { // Hanya update baris jika referensinya sudah ada
...
function createRealtimeView() {
    ...
    // Di sini, kita memastikan 18 baris sudah dibuat dan referensinya disimpan di 'devices'
