// components/RealtimeDashboard.js (Isi dengan kode lama pages/index.js)

import React, { useState, useEffect, useCallback } from 'react';
import mqtt from 'mqtt';
import { formatOperatingTime } from '../lib/costUtils'; 
// import { supabase } from '../lib/supabaseClient'; // Tidak diimpor
    ...
    useEffect(() => {
        ...
        client.on('message', (topic, message) => {
            try {
                ...
                // Pastikan key yang masuk adalah huruf besar (seperti dari ESP32)
